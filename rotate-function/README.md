<h2>396. Rotate Function</h2><h3>Medium</h3><hr><div><p>You are given an integer array <code>nums</code> of length <code>n</code>.</p>
...
<pre><strong>Input:</strong> nums = [1000000007]
